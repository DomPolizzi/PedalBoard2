      ...
      paramComboBox (0)
{
    ...
    ccComboBox->setTextWhenNothingSelected (juce::String());
    ...
    rangeLabel->setColour (juce::Label::textColourId, Colours::black);
    rangeLabel->setColour (juce::Label::backgroundColourId, Colour (0x0));
    ...
    paramComboBox->setTextWhenNothingSelected (juce::String());
	...
	ccComboBox->setSelectedId(cc+2, juce::NotificationType::dontSendNotification);
	latchButton->setToggleState(latch, juce::NotificationType::dontSendNotification);
	slider->setMaxValue(upperBound, juce::NotificationType::dontSendNotification);
	slider->setMinValue(lowerBound, juce::NotificationType::dontSendNotification);
...
{
	paramComboBox->setSelectedId(index+1, juce::NotificationType::dontSendNotification);
}
