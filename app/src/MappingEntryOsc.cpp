      ...
      oscParamSlider (0)
{
    ...
    addressLabel->setColour (juce::Label::textColourId, Colours::black);
    addressLabel->setColour (juce::Label::backgroundColourId, Colour (0x0));
    ...
    addressEditor->setTextWhenNothingSelected (juce::String());
    ...
    oscParamLabel->setColour (juce::Label::textColourId, Colours::black);
    oscParamLabel->setColour (juce::Label::backgroundColourId, Colour (0x0));
	...
	addressLabel->setColour(juce::Label::textColourId,
							ColourScheme::getInstance().colours["Text Colour"]);
	oscParamLabel->setColour(juce::Label::textColourId,
							 ColourScheme::getInstance().colours["Text Colour"]);
